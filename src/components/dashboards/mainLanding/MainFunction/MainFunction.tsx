...
const twoContent =
  'Сервис проводит глубокий анализ финансовых показателей контрагентов, включая доходы, расходы, прибыль, задолженности и другие финансовые показатели. Это позволяет оценить финансовую устойчивость контрагента и предсказать его вероятность банкротства или финансовых проблем.';
