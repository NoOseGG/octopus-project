...
const MainInfoSoleTrade: React.FC = () => {
  ...
  return (
    <Container value={isDate}>
      <CreatedCount legalEntity={EntityType.SOLE_TRADE} countType={COUNT_TYPE.CREATED_SOLE_TRADE_ALL} />
      <CountYearSoleTrade />
      {/*<CreatedCount legalEntity={EntityType.SOLE_TRADE} dynamicPath={DynamicPath.CREATED_SOLE_TRADE_YEAR} />*/}
      <CreatedCount legalEntity={EntityType.SOLE_TRADE} countType={COUNT_TYPE.CREATED_SOLE_TRADE_QUARTER} />
      <CreatedCount legalEntity={EntityType.SOLE_TRADE} countType={COUNT_TYPE.CREATED_SOLE_TRADE_OPERATION} />
    </Container>
  );
};
