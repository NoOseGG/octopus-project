...
import SubjectMetricAddressMain from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectIndicators/SubjectMetricAddressMain/SubjectMetricAddressMain';
import SubjectMetricAddressTwo from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectIndicators/SubjectMetricAddressTwo/SubjectMetricAddressTwo';
import SubjectMetricChangeConstituentDoc from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectIndicators/SubjectMetricChangeConstituentDoc/SubjectMetricChangeConstituentDoc';
import SubjectMetricChangeDirector from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectIndicators/SubjectMetricChangeDirector/SubjectMetricChangeDirector';
import { mediaMax } from '@app/styles/themes/constants';
import SubjectMetricEntityContact from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectIndicators/SubjectMetricEntityContact/SubjectMetricEntityContact';
