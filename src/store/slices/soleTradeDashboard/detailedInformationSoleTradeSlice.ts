...
export const doGetDetailedInformationCompanySoleTrade = createAsyncThunk<ResponseDetailedInformation, RequestData>(
...
const detailedInformationSoleTradeSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder.addCase(doGetDetailedInformationCompanySoleTrade.pending, (state) => {
      state.loading = true;
    });
