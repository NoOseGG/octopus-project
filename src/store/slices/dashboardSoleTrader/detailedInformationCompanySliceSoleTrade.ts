...
export const doGetDetailedInformationCompanySoleTrade = createAsyncThunk<IInitialState, RequestData>(
...
const detailedInformationCompanySoleTradeSlice = createSlice({
  name: 'detailedInformationCompanySoleTrade',
  initialState,
  reducers: {},
  extraReducers: (builder) => {
    builder.addCase(doGetDetailedInformationCompanySoleTrade.fulfilled, (state, action) => {
      state.results = action.payload.results;
    });
  },
});

export default detailedInformationCompanySoleTradeSlice.reducer;
