...
import { doGetDataForColumnChartSoleTrade } from '@app/store/slices/dashboardSoleTrader/mainInfoSoleTraderSlice';

const ColumnChartMonthSoleTrade: React.FC = () => {
  const columnChart = useAppSelector((state) => state.mainInfoSoleTrade.columnChart);
