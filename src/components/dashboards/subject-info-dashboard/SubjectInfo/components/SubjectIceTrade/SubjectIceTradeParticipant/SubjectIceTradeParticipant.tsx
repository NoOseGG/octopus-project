...
const SubjectIceTradeCustomer: React.FC<MyComponentProps> = ({ icetrade_participant }) => {
  ...
  const [selectedIceTradeCustomer, setSelectedIceTradeCustomer] = useState<IceTradeParticipant | null>(
