...
export const serviceForItems: IServiceForItem[] = [
  ...
  },
  {
    ...
    text: 'Банки и другие финансовые организации, которые обязаны проверять своих клиентов для предотвращения мошенничества и соблюдения нормтивных требований.',
  },
  {
    icon: stateOwned,
