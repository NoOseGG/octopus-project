      ...
      <ModalContent>
        <PayAttentionContainer>
          ...
          <Text>
            ...
            контактных телефонах которых размещены в настоящем веб-сервисе, с предложением товаров, работ, услуг{' '}
          ...
          <Text>
            <strong>Аналогичной позиции придерживается и Национальный центр по защите персональных данных.</strong>
          </Text>
          <Text>
