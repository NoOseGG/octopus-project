...
import SubjectPhones from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectContacts/SubjectPhones/SubjectPhones';
import SubjectAddresses from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectContacts/SubjectAddresses/SubjectAddresses';
import SubjectWebSites from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectContacts/SubjectWebSites/SubjectWebSites';
import SubjectEmails from '@app/components/dashboards/search-dashboard/SubjectInfo/components/SubjectContacts/SubjectEmails/SubjectEmails';
